...
parser.add_argument('--source_root_path', type=str,
                    default='/data/weizhikai/data/dataset/ultrasound/Thyroid/tn3k', help='root dir for train data')
parser.add_argument('--train_list_path', type=str,
                    default='dataset/Thyroid/tn3k-trainval.json', help='dir for train data')
