...
from trainer import trainer_myo

parser = argparse.ArgumentParser()
parser.add_argument('--source_root_path', type=str,
                    default='/data/weizhikai/data/dataset/ultrasound/MYO/CAMUS3K', help='root dir for train data')
parser.add_argument('--train_list_path', type=str,
                    default='', help='dir for train data')
...
parser.add_argument('--Source_Dataset', type=str, default='CAMUS3K',
                    help='CAMUS3K')
parser.add_argument('--Target_Dataset', nargs='+', type=str, default=['HMCQU'],
                    help='HMCQU')
...
parser.add_argument('--warmup_period', type=int, default=350,
