...
from trainer import trainer_busi

parser = argparse.ArgumentParser()
parser.add_argument('--source_root_path', type=str,
                    default='/data/weizhikai/data/dataset/ultrasound/BUS/BUSI', help='root dir for train data')
parser.add_argument('--train_list_path', type=str,
                    default='dataset/BUSI/train.txt', help='dir for train data')
parser.add_argument('--target_root_path1', type=str,
                    default='/data/weizhikai/data/dataset/ultrasound/BUS/DatasetB/BUS', help='root dir1 for test data1')
