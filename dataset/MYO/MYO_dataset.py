...
class CAMUS3KDataset(Dataset):
    def __init__(self, root, list_path, mode, num_class, joint_augment=None, augment=None, target_augment=None, lb_change=True):
        ...
        self.lb_dir = os.path.join(root, 'labels')
    ...
    def __getitem__(self, index):
        ...
        lbl_file = os.path.join(self.lb_dir, img_name + '_gt.jpg')
...
if __name__ == '__main__':
    ...
    target_transform = transforms.Compose([
        transforms.ToTensor()])
    train_set = CAMUS3KDataset(root='cfg.DATASET.DATA_DIR', img_list='cfg.DATASET.TRAIN_LIST',
